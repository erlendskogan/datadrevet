...
> Norsk arbeidsversjon. Den innleverte engelske teksten står i [`main.tex`](main.tex) (Data Cleaning).
> Kode: `src/2_manglende_verdier.py`.

Av 98 101 rader mangler 9 448 minst én verdi, og avling mangler i alle sammen. Vi undersøkte først hvorfor verdiene mangler, siden årsaken avgjør hvilken metode som passer. Tabell 5 oppsummerer stegene.
