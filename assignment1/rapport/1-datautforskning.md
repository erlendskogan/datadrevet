...
**1b.** *Manglende verdier.* Bare målingene har manglende verdier: 7,3 % i areal, 5,9 % i produksjon og 9,6 % i avling (Figur 1). I 5 622 rader mangler alle tre. Det finnes ingen duplikater.

*Outliers.* Maksimumsverdiene ligger langt over tredje kvartil, for produksjon 5 360 ganger Q3 (Figur 2). IQR-regelen brukt per vekst flagger 13–14 % av verdiene for areal og produksjon og 4,5 % av avlingene. De største verdiene er likevel reelle, for eksempel Indias rismarker (45 millioner ha), Brasils sukkerrør (769 millioner tonn) og nederlandsk innendørs sopp (5 085 tonn/ha). Mange flaggede verdier er altså trolig ekte variasjon i landstørrelse og produksjonsform, ikke målefeil. Areal og produksjon har også over 2 100 nuller hver. Håndteringen kommer i oppgave 3.

*Kategoriske kolonner.* `Area` har 200 land og `Item` 118 vekster, men antall rader per kategori varierer fra 11 (Færøyene, talgtrefrø) til 1 298 (Kina). 13 av vekstene er sekkekategorier («nes», not elsewhere specified) med 12 944 rader. Det høye antallet kategorier påvirker valget av encoding i oppgave 4.
...
![Figur 1](figurer/fig1_manglende.png)

**Figur 1:** Andel manglende verdier per måling. Area, Item og Year har ingen.

![Figur 2](figurer/fig2_boksplott_log.png)

**Figur 2:** Boksplott på log-skala med værhår ved 1,5 × IQR. Nuller (2 179 i areal, 2 132 i produksjon, 30 i avling) kan ikke vises på log-skala og er utelatt.
